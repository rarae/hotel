...
<head>
    ...
    <script>
        Win10.onReady(function () {
            ...
            //设置壁纸
            Win10.setBgUrl({
                main:'./img/wallpapers/hotel_bg.jpg',
...
<div id="win10">
    <div class="desktop">
        <div id="win10-shortcuts" class="shortcuts-hidden">
            ...
            <%--<div class="shortcut" onclick="Win10.openUrl('./guest_info_input.html','客户信息录入')">--%>
                <%--<img class="icon" src="./img/icon/customer.png"/>--%>
                <%--<div class="title">客户信息录入</div>--%>
            <%--</div>--%>

            <div class="shortcut" onclick="Win10.openUrl('./guest_info_manage.html','客户信息管理')">
                <img class="icon" src="./img/icon/customer.png"/>
                <div class="title">客户信息管理</div>
            </div>

            <div class="shortcut" onclick="Win10.openUrl('./room_manage.html','前台服务')">
                <img class="icon" src="./img/icon/room.png"/>
                <div class="title">前台服务</div>
            </div>

            <div name='system' class="shortcut" onclick="Win10.openUrl('./guest_room_rank_manage.html','客房等级管理')" <%  if(request.getSession().getAttribute("username")!=null) if(request.getSession().getAttribute("username").toString().startsWith("recep")) out.print("style=\"display:none;\""); %> >
                <img class="icon" src="./img/icon/rank.ico"/>
                <div class="title">客房等级管理</div>
            </div>

            <div name='system' class="shortcut" onclick="Win10.openUrl('./guest_room_manage.html','客房管理')" <%  if(request.getSession().getAttribute("username")!=null) if(request.getSession().getAttribute("username").toString().startsWith("recep")) out.print("style=\"display:none;\""); %> >
                <img class="icon" src="./img/icon/room.png"/>
                <div class="title">客房管理</div>
            </div>


            <%--<div class="shortcut" onclick="Win10.openUrl('https://www.panda.tv/26668','图拉夫')">--%>
                <%--<img class="icon" src="./img/icon/ToveLo.jpeg"/>--%>
                <%--<div class="title">图拉夫</div>--%>
            <%--</div>--%>

            <%--<div class="shortcut" onclick="Win10.openUrl('https://www.panda.tv/20641','托马斯')">--%>
                <%--<img class="icon" src="./img/icon/托马斯.jpeg"/>--%>
                <%--<div class="title">托马斯</div>--%>
            <%--</div>--%>
            ...
            <div class="menu_group">
                ...
                <div loc="1,1" size="6,3" class="block">
                    <div class="content red detail" >
                        <%--<iframe style="margin-top: 10px" frameborder="no" border="0" marginwidth="0" marginheight="0" width=264 height=110 src="//music.163.com/outchain/player?type=2&id=108478&auto=1&height=66"></iframe>--%>
                    </div>
